...
./dotsboxes ./edging_player.so ./first_opening_player.so ./mockery_player.so ./naive_eager_player.so ./snake_oil_player.so <<< "3 5"
./dotsboxes ./edging_player.so ./first_opening_player.so ./mockery_player.so ./naive_eager_player.so ./snake_oil_player.so <<< "4 6"
./dotsboxes ./edging_player.so ./first_opening_player.so ./mockery_player.so ./naive_eager_player.so ./snake_oil_player.so <<< "5 7"
./dotsboxes ./edging_player.so ./first_opening_player.so ./mockery_player.so ./naive_eager_player.so ./snake_oil_player.so <<< "6 8"
./dotsboxes ./edging_player.so ./first_opening_player.so ./mockery_player.so ./naive_eager_player.so ./snake_oil_player.so <<< "7 9"