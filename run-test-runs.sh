...
./dotsboxes ./edging_player.so ./first_opening_player.so ./mockery_player.so ./naive_eager_player.so <<< "6 8"
./dotsboxes ./edging_player.so ./first_opening_player.so ./mockery_player.so ./naive_eager_player.so <<< "7 9"